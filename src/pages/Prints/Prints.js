...
function CreateNewPrint(props) {
	var Converter = function (element, callback) {
		var file = element.files[0];
		var reader = new FileReader();
		reader.onloadend = function () {
			var str = reader.result;
			callback(str.substring(str.indexOf(",") + 1));
		};
		...
		<div>
			...
			<div className="row-input">
				...
				<input
					type="text"
					id="width"
					placeholder="Ширина не больше 125"
			...
			<div className="row-input">
				...
				<input
					type="text"
					id="height"
					placeholder="Высота не больше 125"
			...
			<div className="row-input">
				...
				<input
					...
					accept={"image/*"}
					onChange={
						event => Converter(event.target, props.onSetImage)
						// props.onSetImage(
